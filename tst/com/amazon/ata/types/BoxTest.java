...
public class BoxTest {
    ...
    @Test
    public void getMassWhenMaterialIsLaminatedPlastic_calculatesMass_returnsCorrectMass() {
        // GIVEN
        packaging = new Box(Material.LAMINATED_PLASTIC, BigDecimal.TEN, BigDecimal.TEN, BigDecimal.valueOf(20));
    ...
    @Test
    public void hashCodeOLaminatedPlastic_equalObjects_equalHash() {
        // GIVEN
        Packaging packaging = new Box(Material.LAMINATED_PLASTIC, packagingLength, packagingWidth, packagingHeight);
        Packaging other = new Box(Material.LAMINATED_PLASTIC, packagingLength, packagingWidth, packagingHeight);
