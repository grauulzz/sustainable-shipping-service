...
public class PolyBagTest {
    ...
    @Test
    public void getMassWhenMaterialIsCorrugate_calculatesMass_returnsCorrectMass() {
        // GIVEN
        packaging = new PolyBag(Material.CORRUGATE, BigDecimal.TEN, BigDecimal.TEN, BigDecimal.valueOf(20));
    ...
    public void equals_sameObject_isTrue() {
        // GIVEN
        Packaging packaging = new PolyBag(Material.LAMINATED_PLASTIC, packagingLength, packagingWidth, packagingHeight);
    ...
    public void equals_differentClass_returnsFalse() {
        // GIVEN
        Packaging packaging = new PolyBag(Material.CORRUGATE, packagingLength, packagingWidth, packagingHeight);
    ...
    public void equals_sameAttributes_returnsTrue() {
        // GIVEN
        Packaging packaging = new PolyBag(Material.CORRUGATE, packagingLength, packagingWidth, packagingHeight);
        Object other = new PolyBag(Material.CORRUGATE, packagingLength, packagingWidth, packagingHeight);
    ...
    public void hashCode_equalObjects_equalHash() {
        // GIVEN
        Packaging packaging = new PolyBag(Material.LAMINATED_PLASTIC,
                packagingLength, packagingWidth, packagingHeight);

        Packaging other = new PolyBag(Material.LAMINATED_PLASTIC, packagingLength,
                packagingWidth, packagingHeight);
    ...
    @Test
    public void hashCodeOfCorrugate_equalObjects_equalHash() {
        // GIVEN
        Packaging packaging = new PolyBag(Material.CORRUGATE,
                packagingLength, packagingWidth, packagingHeight);

        Packaging other = new PolyBag(Material.CORRUGATE, packagingLength,
                packagingWidth, packagingHeight);
