...
public class CarbonCostStrategyTest {
    ...
    void getCost_corrugateMaterial_returnsCorrectCarbonCost() {
        ...
        // THEN
        assertEquals(0, BigDecimal.valueOf(17.00).compareTo(shipmentCost.getCost()), "Incorrect carbon cost calculation for a box with dimensions 10x10x20.");
    }
    ...
    void getCost_laminatedPlasticMaterial_returnsCorrectCarbonCost() {
        ...
        // THEN 0.3240
        assertEquals(0, BigDecimal.valueOf(0.3240).compareTo(shipmentCost.getCost()), "Incorrect carbon cost calculation for a polybag with a volume of 20000cc.");
    }
